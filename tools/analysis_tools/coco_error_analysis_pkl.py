...
def main():
    ...
    parser.add_argument('result', help='result file (pickle format) path')
    ...
    dataset.format_results(mmcv.load(args.result), jsonfile_prefix=args.result[:-4])

    analyze_results(
        args.result.replace('pkl', 'bbox.json'),
