...
def imshow_det_bboxes(img,
    ...
    group_color = {
        "f": color_val_matplotlib("blue"),
        "c": color_val_matplotlib("green"),
        "r": color_val_matplotlib("red")
    }
    ...
    for i, (bbox, label) in enumerate(zip(bboxes, labels)):
        ...
        # print(label)
        # print(freqdict[label])
        # try:
        if freqdict[class_names[label]] == 'c':
            continue
        color.append(group_color[freqdict[class_names[label]]])
        # except Exception:
        #     continue
